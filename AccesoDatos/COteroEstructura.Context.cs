...
namespace AccesoDatos
{
    ...
    public partial class COteroEstructuraEntities1 : DbContext
    {
        public COteroEstructuraEntities1()
            : base("name=COteroEstructuraEntities1")
        {
        }
        ...
        public virtual DbSet<VistaEmpleado> VistaEmpleadoes { get; set; }
        ...
        public virtual int EmpleadoGetByName(string nombre)
        {
            var nombreParameter = nombre != null ?
                new ObjectParameter("Nombre", nombre) :
                new ObjectParameter("Nombre", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("EmpleadoGetByName", nombreParameter);
        }
